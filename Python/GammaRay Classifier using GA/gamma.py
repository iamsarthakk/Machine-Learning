...
#clean the data by shuffling and reassigning the indexes to the shuffled data
...
tpot = TPOTClassifier(generations=5, verbosity=2)   #tpot store sbest ml model for classification
